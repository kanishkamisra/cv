...
2025 & Lalchand Pandia, Allyson Ettinger, \textbf{Kanishka Misra}. On Diversity vs. Difficulty for Data Selection. \textit{Submitted.}\\

2025 & Sanghee Kim, \textbf{Kanishka Misra}. Hey, wait a minute: On at-issue sensitivities in Language Models. \textit{Submitted.}\\

2025 & Daniel Brubaker, William Sheffield, Junyi Jessy Li, \textbf{Kanishka Misra}. \href{https://arxiv.org/abs/2510.09556}{\textsc{wugnectives}: Novel Entity Inferences of Language Models from Discourse Connectives}. \textit{Submitted.}\\
...
\renewcommand*{\arraystretch}{1.5}
\begin{longtable}{p{.05\textwidth}  p{.90\textwidth} }
2025 & \textbf{Donald D. Harrington Faculty Fellowship}. \textit{Research Fellowship at the Department of Linguistics, UT-Austin.} \textbf{Amount:} \$75,000 in research funds.\\
...
\begin{longtable}{p{.09\textwidth}  p{.86\textwidth} }
    ...
    \textbf{2024--} & \textbf{Tianyang Xu} (PhD Student at TTIC, advised by Dr. Karen Livescu). \textbf{Topic(s):} \textit{Multimodal signals to learning linguistic generalizations.}\\
...
\begin{longtable}{p{.15\textwidth}  p{.80\textwidth} }
    \textbf{Grants} & US National Science Foundation - SBE directorate (2024); Panel Member for NSF CISE/IIS (2025); Israeli Ministry of Innovation, Science and Technology (2025)\\
    \textbf{Journal} & \textit{Annals of the New York Academy of Science} (2025); \textit{Brain and Behavioral Sciences} (2025); \textit{Open Mind} (2025); \textit{Journal of Memory and Language} (2024); \textit{Computational Linguistics} (2024); \textit{PNAS Nexus} (2024); \textit{Cognitive Science} (2023); \textit{Open Mind} (2023)\\
...
\begin{itemize}
    ...
    \item \textbf{Area Chair/Meta Reviewer}, ACL Rolling Review (ARR) 2024 (Feb, April, June, October); 2025 (Feb - \textit{emergency}, May, October).
